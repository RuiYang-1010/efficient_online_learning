                            ...
                            const vision_msgs::Detection2DArrayConstPtr& in_image_detections)
{
        ...
        for(size_t i = 0; i < in_clusters.clusters.size(); i++) {
                ...
                // std::vector<Eigen::Vector4d, Eigen::aligned_allocator<Eigen::Vector4d> > vertices_3dbox;
                // Eigen::Vector4d left_back_down(in_clusters.clusters[i].bounding_box.pose.position.x - in_clusters.clusters[i].bounding_box.dimensions.x/2, in_clusters.clusters[i].bounding_box.pose.position.y - in_clusters.clusters[i].bounding_box.dimensions.y/2, in_clusters.clusters[i].bounding_box.pose.position.z - in_clusters.clusters[i].bounding_box.dimensions.z/2, 1);
                // Eigen::Vector4d right_back_down(in_clusters.clusters[i].bounding_box.pose.position.x + in_clusters.clusters[i].bounding_box.dimensions.x/2, in_clusters.clusters[i].bounding_box.pose.position.y - in_clusters.clusters[i].bounding_box.dimensions.y/2, in_clusters.clusters[i].bounding_box.pose.position.z - in_clusters.clusters[i].bounding_box.dimensions.z/2, 1);
                // Eigen::Vector4d right_front_down(in_clusters.clusters[i].bounding_box.pose.position.x + in_clusters.clusters[i].bounding_box.dimensions.x/2, in_clusters.clusters[i].bounding_box.pose.position.y + in_clusters.clusters[i].bounding_box.dimensions.y/2, in_clusters.clusters[i].bounding_box.pose.position.z - in_clusters.clusters[i].bounding_box.dimensions.z/2, 1);
                // Eigen::Vector4d left_front_down(in_clusters.clusters[i].bounding_box.pose.position.x - in_clusters.clusters[i].bounding_box.dimensions.x/2, in_clusters.clusters[i].bounding_box.pose.position.y + in_clusters.clusters[i].bounding_box.dimensions.y/2, in_clusters.clusters[i].bounding_box.pose.position.z - in_clusters.clusters[i].bounding_box.dimensions.z/2, 1);
                // Eigen::Vector4d left_back_up(in_clusters.clusters[i].bounding_box.pose.position.x - in_clusters.clusters[i].bounding_box.dimensions.x/2, in_clusters.clusters[i].bounding_box.pose.position.y - in_clusters.clusters[i].bounding_box.dimensions.y/2, in_clusters.clusters[i].bounding_box.pose.position.z + in_clusters.clusters[i].bounding_box.dimensions.z/2, 1);
                // Eigen::Vector4d right_back_up(in_clusters.clusters[i].bounding_box.pose.position.x + in_clusters.clusters[i].bounding_box.dimensions.x/2, in_clusters.clusters[i].bounding_box.pose.position.y - in_clusters.clusters[i].bounding_box.dimensions.y/2, in_clusters.clusters[i].bounding_box.pose.position.z + in_clusters.clusters[i].bounding_box.dimensions.z/2, 1);
                // Eigen::Vector4d right_front_up(in_clusters.clusters[i].bounding_box.pose.position.x + in_clusters.clusters[i].bounding_box.dimensions.x/2, in_clusters.clusters[i].bounding_box.pose.position.y + in_clusters.clusters[i].bounding_box.dimensions.y/2, in_clusters.clusters[i].bounding_box.pose.position.z + in_clusters.clusters[i].bounding_box.dimensions.z/2, 1);
                // Eigen::Vector4d left_front_up(in_clusters.clusters[i].bounding_box.pose.position.x - in_clusters.clusters[i].bounding_box.dimensions.x/2, in_clusters.clusters[i].bounding_box.pose.position.y + in_clusters.clusters[i].bounding_box.dimensions.y/2, in_clusters.clusters[i].bounding_box.pose.position.z + in_clusters.clusters[i].bounding_box.dimensions.z/2, 1);
                // vertices_3dbox.push_back(left_back_down);
                // vertices_3dbox.push_back(right_back_down);
                // vertices_3dbox.push_back(right_front_down);
                // vertices_3dbox.push_back(left_front_down);
                ...
                for(size_t j = 0; j < in_image_detections->detections.size(); j++) {
                        if(in_image_detections->detections[j].results[0].score > 0.5) {
...
int main(int argc, char **argv)
{
        ...
        //image_detections_cache.registerCallback(velodyne_callback);
