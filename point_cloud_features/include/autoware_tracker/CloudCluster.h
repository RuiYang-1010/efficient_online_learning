// Generated by gencpp from file autoware_tracker/CloudCluster.msg
// DO NOT EDIT!


#ifndef AUTOWARE_TRACKER_MESSAGE_CLOUDCLUSTER_H
#define AUTOWARE_TRACKER_MESSAGE_CLOUDCLUSTER_H
...
struct CloudCluster_
{
  ...
  typedef boost::shared_ptr< ::autoware_tracker::CloudCluster_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autoware_tracker::CloudCluster_<ContainerAllocator> const> ConstPtr;

}; // struct CloudCluster_

typedef ::autoware_tracker::CloudCluster_<std::allocator<void> > CloudCluster;

typedef boost::shared_ptr< ::autoware_tracker::CloudCluster > CloudClusterPtr;
typedef boost::shared_ptr< ::autoware_tracker::CloudCluster const> CloudClusterConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autoware_tracker::CloudCluster_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autoware_tracker::CloudCluster_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::autoware_tracker::CloudCluster_<ContainerAllocator1> & lhs, const ::autoware_tracker::CloudCluster_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::autoware_tracker::CloudCluster_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autoware_tracker::CloudCluster_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_tracker::CloudCluster_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_tracker::CloudCluster_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_tracker::CloudCluster_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_tracker::CloudCluster_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autoware_tracker::CloudCluster_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autoware_tracker::CloudCluster_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xee7b21b447ceefbaULL;
  static const uint64_t static_value2 = 0x70710356a4b6162bULL;
};

template<class ContainerAllocator>
struct DataType< ::autoware_tracker::CloudCluster_<ContainerAllocator> >
{
  static const char* value()
  {
    return "autoware_tracker/CloudCluster";
  }
...
template<class ContainerAllocator>
struct Definition< ::autoware_tracker::CloudCluster_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autoware_tracker::CloudCluster_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autoware_tracker::CloudCluster_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_tracker::CloudCluster_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AUTOWARE_TRACKER_MESSAGE_CLOUDCLUSTER_H
