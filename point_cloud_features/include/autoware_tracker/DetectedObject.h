// Generated by gencpp from file autoware_tracker/DetectedObject.msg
// DO NOT EDIT!


#ifndef AUTOWARE_TRACKER_MESSAGE_DETECTEDOBJECT_H
#define AUTOWARE_TRACKER_MESSAGE_DETECTEDOBJECT_H
...
struct DetectedObject_
{
  ...
  typedef boost::shared_ptr< ::autoware_tracker::DetectedObject_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autoware_tracker::DetectedObject_<ContainerAllocator> const> ConstPtr;

}; // struct DetectedObject_

typedef ::autoware_tracker::DetectedObject_<std::allocator<void> > DetectedObject;

typedef boost::shared_ptr< ::autoware_tracker::DetectedObject > DetectedObjectPtr;
typedef boost::shared_ptr< ::autoware_tracker::DetectedObject const> DetectedObjectConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autoware_tracker::DetectedObject_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autoware_tracker::DetectedObject_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::autoware_tracker::DetectedObject_<ContainerAllocator1> & lhs, const ::autoware_tracker::DetectedObject_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::autoware_tracker::DetectedObject_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autoware_tracker::DetectedObject_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_tracker::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_tracker::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_tracker::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_tracker::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autoware_tracker::DetectedObject_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autoware_tracker::DetectedObject_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3dd3b39b0fe0d68fULL;
  static const uint64_t static_value2 = 0xdfd6e1f764955599ULL;
};

template<class ContainerAllocator>
struct DataType< ::autoware_tracker::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
    return "autoware_tracker/DetectedObject";
  }
...
template<class ContainerAllocator>
struct Definition< ::autoware_tracker::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autoware_tracker::DetectedObject_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autoware_tracker::DetectedObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_tracker::DetectedObject_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AUTOWARE_TRACKER_MESSAGE_DETECTEDOBJECT_H
